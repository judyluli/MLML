        ...
        with tf.Session() as sess:
            ...
            for i in range(self.epoches):
                ...
                for j in range(steps_per_epoch):
                    ...
                    sess.run(self.trainer,feed_dict={self.input_x:rand_x,self.input_y:rand_y,self.phase:True})
                trainlossv,loglossv,acelossv = sess.run([self.totalloss,self.logloss,self.aceloss],feed_dict={self.input_x:data_x,self.input_y:data_y,self.phase:False})
                testlossv,predictionv = sess.run([self.totalloss,self.prediction],feed_dict={self.input_x:test_x,self.input_y:test_y,self.phase:False})
